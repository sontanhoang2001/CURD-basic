...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate confirm fullname
    if (empty(trim($_POST["fullname"]))) {
        $fullname_err = "Vui lòng nhập tên đầy đủ";
    } elseif (!preg_match('/^[a-zA-Z0-9_]+$/', trim($_POST["username"]))) {
        $fullname_err = "Tên đăng nhập chỉ được sử dụng chữ cái, số và dấu gạch dưới";
    } else {
            ...
            <div class="col-md-4 mt-5">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fullname" class="form-control <?php echo (!empty($confirm_fullname_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $fullname; ?>">
